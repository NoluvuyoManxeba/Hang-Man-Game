...
const wordList = ['Tiger', 'Lion', 'Elephant', 'Hippo'];
...
const App = () => {
  ...
  const hangmanImages = [
    require('./hangmandrawings/state1.GIF'),
    require('./hangmandrawings/state2.GIF'),
    require('./hangmandrawings/state3.GIF'),
    require('./hangmandrawings/state4.GIF'),
    require('./hangmandrawings/state5.GIF'),
    require('./hangmandrawings/state6.GIF'),
    require('./hangmandrawings/state7.GIF'),
    require('./hangmandrawings/state8.GIF'),
    require('./hangmandrawings/state9.GIF'),
    require('./hangmandrawings/state10.gif'),
    require('./hangmandrawings/state11.GIF'),
  ];
